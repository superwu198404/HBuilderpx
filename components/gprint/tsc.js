...
var jpPrinter = {
  createNew: function () {
	...
	// jpPrinter.init = function(maxHeight) {
	// 	data = "! 50 200 200 " + maxHeight + " 1\r\n"
    ...
    */
	...
	jpPrinter.diyCode = function(content) { //自定义指令
		jpPrinter.addCommand(content);
	};
	
	jpPrinter.pushCode = function(content) { //推送指令
		content.forEach((el)=>{
			command.push(el)
		}) 
